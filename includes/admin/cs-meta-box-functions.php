<?php
/**
 * CommuntiyService Meta Box Functions
 *
 * @author      Lazutina
 * @category    Core
 * @package     CommuntiyService/Admin/Functions
 * @version     2.3.0
 */
if ( ! defined( 'ABSPATH' ) ) {
 ...
 * @param array $field
 */
function communtiyservice_wp_text_input( $field ) {
 ...
 * @param array $field
 */
function communtiyservice_wp_hidden_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function communtiyservice_wp_textarea_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function communtiyservice_wp_checkbox( $field ) {
	global $thepostid, $post;
 ...
 */
function communtiyservice_wp_select( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function communtiyservice_wp_radio( $field ) {
	global $thepostid, $post;
