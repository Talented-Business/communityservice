...
class CS_Admin {
	...
	public function __construct() {
		...
		//add_action( 'admin_footer', 'cs_print_js', 25 );
	...
	public function includes() {
		include_once dirname( __FILE__ ) . '/cs-admin-functions.php';
		include_once dirname( __FILE__ ) . '/cs-meta-box-functions.php';
		include_once dirname( __FILE__ ) . '/class-cs-admin-post-types.php';
		return;
	...
	public function conditional_includes() {
		...
		switch ( $screen->id ) {
			...
			case 'dashboard-network':
				//include 'class-cs-admin-dashboard.php';
				break;
			case 'options-permalink':
				//include 'class-cs-admin-permalink-settings.php';
				break;
			case 'plugins':
	...
	public function admin_redirects() {
		...
		if ( get_transient( '_wc_activation_redirect' ) ) {
			...
			if ( CS_Admin_Notices::has_notice( 'install' ) ) {
	 ...
	 *
	 * See: CS_Admin_Setup_Wizard::install_jetpack()
	 */
